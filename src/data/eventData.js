...
export const venue = {
  ...
  mapEmbedUrl: '',   // opcionális: Google Maps "Beágyazás" URL (iframe src). Ha üres, a stilizált térkép látszik.
}
...
export const artists = [
  ...
  { id: 'siryx', name: 'DJ 1', genre: 'HARDSTYLE', image: '/images/cover.jpg',
    ...
    instagram: 'https://instagram.com/', soundcloud: 'https://soundcloud.com/', previewTrackId: 'break-it-down' },
